...
******************************************************************/
	...
	switch ( theme ) {
		case "whiteboard":
			...
			pen = [ 'url(' + path + 'plugin/chalkboard/img/boardmarker.png), auto',
				'url(' + path + 'plugin/chalkboard/img/boardmarker.png), auto' ];
		...
		default:
			...
			pen = [ 'url(' + path + 'plugin/chalkboard/img/boardmarker.png), auto',
				'url(' + path + 'plugin/chalkboard/img/chalk.png), auto' ];
...
//alert("Buttons");
	...
	function setupDrawingCanvas( id ) {
		...
		sponge.src = path + 'plugin/chalkboard/img/sponge.png';
		sponge.id = "sponge";
